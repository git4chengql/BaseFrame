...
public class CustomProcessDiagramGenerator {
    ...
    private static Color HISTORY_COLOR2 = Color.ORANGE;
    private static Color HISTORY_COLOR3 = Color.PINK;
    private static Color HISTORY_COLOR4 = Color.BLUE;
    private static Color HISTORY_COLOR5 = Color.BLACK;
            ...
            if (activity != null) {
                if (historicActivityInstance.getEndTime() == null) {
                    ...
                    if ("跳过".equals(deleteReason)) {
                    	...
                    	Color tmp = new Color(0, 255, 0);
                    	int count = 0;
                    	for (Integer integer : temp) {
                    		if(integer==activity.getX()){
                    			count ++;
                    		}
                		}
                    	if(count==1){
                    		tmp=CustomProcessDiagramGenerator.HISTORY_COLOR;
                    	}else if(count==2){
                    		tmp=CustomProcessDiagramGenerator.HISTORY_COLOR2;
                    	}else if(count==3){
                    		tmp=CustomProcessDiagramGenerator.HISTORY_COLOR3;
                    	}else if(count==4){
                    		tmp=CustomProcessDiagramGenerator.HISTORY_COLOR4;
                    	}else if(count>=5){
                    		tmp=CustomProcessDiagramGenerator.HISTORY_COLOR5;
                    	}
    ...
    private static void signHistoryNode(BufferedImage image, int x, int y,
            int width, int height, String activityType,Color nodeColor) {
